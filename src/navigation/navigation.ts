...
export function pushServerListScreen(componentId: string) {
  requestAnimationFrame(() => {
    const theme = themeState.theme

    void Navigation.push(componentId, {
      component: {
        name: SERVER_LIST_SCREEN,
        options: {
          topBar: {
            visible: false,
            height: 0,
...
export function pushServerEditScreen(componentId: string, config: LX.ServerConfig | null) {
  requestAnimationFrame(() => {
    const theme = themeState.theme

    void Navigation.push(componentId, {
      component: {
        name: SERVER_EDIT_SCREEN,
        passProps: {
          config,
        },
        options: {
...
export function pushAlbumDetailScreen(albumId: string) {
  requestAnimationFrame(() => {
    const theme = themeState.theme

    void Navigation.push(HOME_SCREEN, {
      component: {
...
export function pushArtistDetailScreen(artistId: string) {
  requestAnimationFrame(() => {
    const theme = themeState.theme
