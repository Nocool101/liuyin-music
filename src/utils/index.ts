  ...
  if (oldMusicInfo.source == 'local') {
    ...
    switch (oldMusicInfo.source) {
      case 'kg':
        ...
        newInfo.id = oldMusicInfo.hash ? oldMusicInfo.songmid + '_' + oldMusicInfo.hash : newInfo.id
        break
      case 'tx':
        meta.strMediaMid = oldMusicInfo.strMediaMid
        meta.albumMid = oldMusicInfo.albumMid
        meta.id = oldMusicInfo.songId
        if (oldMusicInfo.hash) newInfo.id = oldMusicInfo.songmid + '_' + oldMusicInfo.hash
        break
      case 'mg':
